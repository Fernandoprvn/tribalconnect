...
export default function VillagesPage() {
  ...
  const submitVillage = () => {
    ...
    if ((latitude === undefined) !== (longitude === undefined) || (latitude !== undefined && (!Number.isFinite(latitude) || latitude < -90 || latitude > 90 || !Number.isFinite(longitude) || longitude < -180 || longitude > 180))) { setFormError('Enter both valid latitude and longitude values, or leave both fields blank.'); return; }
    setFormError(null);
